      ...
      <div className='md:grid grid-cols-2 items-center bg-red-500'>
        <div className='px-5 py-5 md:py-0 md:pl-24 md:pr-12 '>
          <div className=' space-y-5 md:space-y-10 text-white'>
            <h1 className='text-3xl md:text-6xl font-md text-white'>About us <br/><h2 className='my-2 font-light text-2xl md:text-5xl '>"Not Just A Logistics Business!"</h2></h1>
        ...
        <img data-aos="zoom-in" className='w-[100%]' src={require('../Assets/website poster.png')}/>
        </div>
        {/*  */}
        <div className='md:grid grid-cols-2 items-center bg-gray-200'>
        <div className=' flex items-center justify-center'>
        <img data-aos="zoom-in" className='w-[100%]' src={require('../Assets/website image.jpg')}/>
        </div>
        <div className='px-5 py-5 md:py-0 md:pl-24 md:pr-12 '>
          <div className='space-y-5 md:space-y-10 text-black'>
          <h1 className='text-3xl md:text-6xl font-md text-red-600'>Our Mission <br/><h2 className='my-2 font-light text-2xl md:text-5xl '>"To Provide Best Logistics Service"</h2></h1><hr className='w-[15%] border-2 border-red-600'/>
            <p align='justify' className='w-[100%] font-light'>
        ...
        <div className='px-5 py-5 md:py-0 md:pl-24 md:pr-12 '>
          <div className='space-y-5 md:space-y-10 text-white'>
          <h1 className='text-3xl md:text-6xl font-md text-white'>Our Vision<br/><h2 className='my-2 font-light text-2xl md:text-5xl '>"Not Just A Logistics Business!"</h2></h1><hr className='w-[15%] border-2 border-red-600'/>
            <p align='justify' className='w-[100%] font-light'>
            Poojs Roadways Trucking mission is to become a recognized leader in India's Transportation industry for long and short distance trucking and transportation goal.
                </p></div>
        </div>
        <img data-aos="zoom-in" className='w-[100%]' src={require('../Assets/website file photo edit.png')}/>
        </div>
