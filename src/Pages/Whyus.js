...
const Whyus = () => {
  const data = [
    ...
    {
      image:
        'https://w7.pngwing.com/pngs/183/217/png-transparent-a-1-hesperia-recycling-co-inc-computer-icons-recycling-symbol-eco-friendly-miscellaneous-angle-leaf.png',
      heading: 'Eco-Friendly Options',
      para: ' Committed to reducing our carbon footprint with environmentally friendly transportation solutions.'
    },
    {
    ...
    {
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS99XLgxCbS9nPfJ8H13gJ7nM2uc04VV4lSew&s',
      heading: 'Innovative Technology',
      para: 'Leveraging the latest in logistics technology to streamline operations and enhance efficiency.'
    }
  ]
  return (
    <Main>
